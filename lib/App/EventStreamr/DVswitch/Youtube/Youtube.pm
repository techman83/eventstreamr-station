package App::EventStreamr::DVswitch::Youtube::Youtube;
use Method::Signatures;
use Moo;
use namespace::clean;

# ABSTRACT: A Youtube process

# VERSION: Generated by DZP::OurPkg:Version

=head1 SYNOPSIS

This Provides a Youtube Process.
...
has 'cmd'         => ( is => 'ro', default => sub { '/usr/local/bin/youtube.sh' } );
